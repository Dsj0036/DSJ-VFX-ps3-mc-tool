...
namespace Destrin_Visual_Tool
{
    public partial class Form1 : Form
    {
        ...
        private void materialButton1_Click_1(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Autorization: Host", "Access Granted", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Ded.debug.debugloader DBGLOADER = new Ded.debug.debugloader();
            DBGLOADER.ShowDialog();
           /// RPC.SetRPC("929438860386140190", "Conectado", "Dev", "largeico", "Dedition VFX RTM Tool", "empty");
